...
class TestFee(object):
    ...
    def setup_class_get_kyc_user_info(self):
        ...
        user_no_kyc_info = user_no_kyc_info['address']
        ...
        yield user_addr, user_no_kyc_info
    ...
    def test_send_fee(self, setup_class_get_kyc_user_info, send_fees):
        ...
        after_user_no_kyc_balance = HttpResponse.get_balance_unit(user_addr)
        # 手续费忽略小数
        assert before_user_balance - after_user_balance == int(send_fees)
        assert before_user_no_kyc_balance - after_user_no_kyc_balance == Compute.to_u(user_send_amount)
